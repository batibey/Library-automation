...
{
    public partial class FrmErkekDetay : Form
    {

        Sqlbaglantisi bgl = new Sqlbaglantisi();
        public FrmErkekDetay()
        {
            InitializeComponent();
        }
        ...
        private void FrmErkekDetay_Load(object sender, EventArgs e)
        {
        ...
        private void BtnKayitEkle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand komut = new SqlCommand("insert into Odunc (AlisT,VerisT,ErkekUyeID,KitapID) values (@p1,@p2,@p3,@p4)", bgl.baglanti());
